...
/**
 * @brief Parses a RFL CSV decision table, compiles it, and builds a KnowledgeBase.
 *
...
/**
 * @brief Parses a CSV decision table from a string, compiles it, and builds a KnowledgeBase.
 *
