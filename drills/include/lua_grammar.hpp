#ifndef LUA_GRAMMAR_HPP
#define LUA_GRAMMAR_HPP
#include "unesc.hpp"
...
namespace lua_grammar {
   ...
   struct pad : tao::pegtl::pad< R, sep > {};
    ...
    struct drl_variable_base : tao::pegtl::seq< tao::pegtl::one< '$' >, tao::pegtl::identifier > {};
    struct drl_variable : tao::pegtl::seq< drl_variable_base, tao::pegtl::star< tao::pegtl::one<'.'>, tao::pegtl::identifier > > {};
   ...
   struct expr_ten;
   struct expr_thirteen : tao::pegtl::seq< tao::pegtl::sor< bracket_expr, name, drl_variable >, tao::pegtl::star< seps, tao::pegtl::sor< function_call_tail, variable_tail > > > {};
