 ...
 * like the TMS and Lua Manager need from the main Rete network.
 */
class INetworkCallback {
public:
    ...
    // Callbacks needed by LuaScriptingManager
    ...
    virtual std::map<std::string, sol::object> const& get_global_values() const = 0;
};
