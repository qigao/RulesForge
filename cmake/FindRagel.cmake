...
if(RAGEL_EXECUTABLE)
    ...
    if(${RAGEL_version_result} EQUAL 0)
        string(
            REGEX
            REPLACE
                "^Ragel State Machine Compiler version ([^ ]+) .*$"
                "\\1"
                RAGEL_VERSION
...
${RAGEL_version_error}"
    ...
    macro(RAGEL_TARGET Name Input Output)
        ...
        if(${ARGC} GREATER 3)
            if(${ARGC} EQUAL 5)
                if("${ARGV3}" STREQUAL "COMPILE_FLAGS")
                    ...
                    separate_arguments(
                        RAGEL_EXECUTABLE_opts
                    )
                else()
                    message(
                        SEND_ERROR ${RAGEL_TARGET_usage}
                    )
                endif()
            else()
        ...
        add_custom_command(
            OUTPUT ${Output}
            COMMAND
                ${RAGEL_EXECUTABLE} ARGS
                ${RAGEL_EXECUTABLE_opts} -o${Output}
                ${Input}
            DEPENDS ${Input}
            COMMENT
        ...
        set(RAGEL_${Name}_COMPILE_FLAGS
            ${RAGEL_EXECUTABLE_opts}
        )
    endmacro()
...
find_package_handle_standard_args(
    RAGEL REQUIRED_VARS RAGEL_EXECUTABLE
