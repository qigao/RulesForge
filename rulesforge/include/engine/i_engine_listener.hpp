...
public:
     ...
     */
    virtual void on_activation_created(std::string const& ruleName, std::vector<Fact*> const& facts) {}
     ...
     */
    virtual void on_activation_retracted(std::string const& ruleName, std::vector<Fact*> const& facts) {
    }
