...
RflToken RflLexer::scan_normal() {
    ...
    /*!re2c
        ...
        "jmespath"   / [^a-zA-Z0-9_] { return make_token(TokenType::TK_JMESPATH, tok_); }
        "dsv"        / [^a-zA-Z0-9_] { return make_token(TokenType::TK_DSV, tok_); }
        "csv"        / [^a-zA-Z0-9_] { return make_token(TokenType::TK_CSV, tok_); }
