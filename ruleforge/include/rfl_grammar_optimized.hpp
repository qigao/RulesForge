#ifndef RFL_GRAMMAR_OPTIMIZED_HPP
#define RFL_GRAMMAR_OPTIMIZED_HPP
...
namespace grammar {
    ...
    #define RFL_HYPHENATED_KEYWORDS(X) \
...
#endif // RFL_GRAMMAR_OPTIMIZED_HPP
