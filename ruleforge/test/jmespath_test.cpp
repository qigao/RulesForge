...
suite("JMESPath") {
    group("Enhanced Array Operations") {
        it("processes product arrays") {
    ...
    group("JSON Processing") {
        it("processes JSON events") {
            auto session = build_session(R"(
                declare JsonEvent
                    type: String
                    data: String
    ...
    group("Function Binding") {
        it("calls jmespath function directly") {
            auto session = build_session(R"(
                declare TestFact
                    name: String
                end
    ...
    group("Real-world E-commerce Analysis") {
        it("performs comprehensive order analysis") {
            auto session = build_session(R"(
