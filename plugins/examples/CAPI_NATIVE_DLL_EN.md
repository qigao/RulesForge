...
This guide explains the native-function extension path in the C API.

Use this when rules need RHS callbacks via invoke.

This is not the standard source/sink plugin ABI.
For standard reusable RulesForge plugins, use the vtable ABI in include/rule_forge_plugin.h and the concrete plugins under RulesForge/plugins.
